...
internal static class StringExtensions
{
	...
	static readonly MethodInfo _stringGetNonRandomizedHashCode = typeof(string).GetMethod("GetNonRandomizedHashCode", BindingFlags.NonPublic | BindingFlags.Instance)!;

	public static int GetStableHashCode(this string str)
	{
		return (int)_stringGetNonRandomizedHashCode.Invoke(str, Array.Empty<object>())!;
	}

	public static int Occurrences(this string str, char item) => str.AsSpan().Occurrences(item);
	public static int Occurrences(this ReadOnlySpan<char> str, char item)
	{
		var count = 0;
		int index;
	...
	public static int Occurrences(this string str, params char[] items) => str.AsSpan().Occurrences(items);
	public static int Occurrences(this ReadOnlySpan<char> str, params char[] items)
	{
		var count = 0;
		int index;
